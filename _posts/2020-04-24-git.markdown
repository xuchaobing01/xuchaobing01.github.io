...
Gitee的官方网站(国内快)：[https://gitee.com/](https://gitee.com/)

Git Cheat Sheet(命令大全)：[Git Cheat Sheet](https://gitee.com/liaoxuefeng/learn-java/raw/master/teach/git-cheatsheet.pdf)

**`Git` 与 `SVN` 区别**

![](img/in-post/post-git/post-git-svn.jpg)
    
**`Git` 工作区、暂存区和版本库**

![](img/in-post/post-git/post-git-stage.jpg)

**`Git Cheat Sheet`**

![](img/in-post/post-git/post-git-cheat-sheet.jpg)
