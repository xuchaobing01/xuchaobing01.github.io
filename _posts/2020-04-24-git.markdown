...
![](/img/in-post/post-git/post-git-both.jpg)

***

Git的官方网站：[http://git-scm.com](http://git-scm.com?_blank "Git官网")

Gitee的官方网站(国内快)：[https://gitee.com/](https://gitee.com/?_blank "Gitee官网")

Git Cheat Sheet(命令大全)：[Git Cheat Sheet](https://gitee.com/liaoxuefeng/learn-java/raw/master/teach/git-cheatsheet.pdf?_blank "Git Cheat Sheet")
...
![Git与SVN区别](/img/in-post/post-git/post-git-svn.jpg)
    
**`Git` 工作区、暂存区和版本库**

![Git工作区、暂存区和版本库](/img/in-post/post-git/post-git-stage.jpg)

**`Git Cheat Sheet`**

![Git Cheat Sheet](/img/in-post/post-git/post-git-cheat-sheet.jpg)
